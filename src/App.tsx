...
import {pickNearestPickupStation, pickNearestRentalStation, pickNearestStation} from "./lib/stations";
import {
    AutocompleteField,
    LocationPanel,
    OriginOptions,
    ...
    useEffect(() => {
        ...
        runNearestTask(
            async () => {
                ...
                let station = pickNearestPickupStation(stations, validOrigin);
                let fallback = false;
                if (!station) {
                    station = pickNearestRentalStation(stations, validOrigin);
                    fallback = true;
                }
                if (!station) {
    ...
    useEffect(() => {
        ...
        runPlanTask(
            async () => {
                ...
                const pickup = pickNearestPickupStation(stations, validOrigin);
